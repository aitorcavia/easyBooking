package easyBookingClient_AmericanAirlines.client.gui;
...
import easyBookingClient_AmericanAirlines.client.controller.AmeAirlinesController;
...
public class SwitchServerGUI {
	...
	private AmeAirlinesController controller;

	public SwitchServerGUI(AmeAirlinesController controller) {
	...
	private void initialize() {
		...
		btnSwitchServer.setForeground(Color.RED);
